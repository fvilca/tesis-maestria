...
namespace gSLICr
{
	namespace engines
	{
		...
		protected:
			...
			virtual void Init_Cluster_Centers2() = 0;
			virtual void Find_Center_Association() = 0;
			virtual void Find_Center_Association2() = 0;
			virtual void Update_Cluster_Center() = 0;
			virtual void Update_Cluster_Center2() = 0;
		...
		public:
			...
			void Perform_Segmentation2(UChar4Image* in_img);
